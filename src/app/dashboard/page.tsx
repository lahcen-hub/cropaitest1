...
export default function DashboardPage() {
    ...
    const allFeatureCards = [
        ...
        {
            title: "Farm Calendar",
            description: "Get a personalized irrigation and fertilization schedule for your crops.",
        ...
        },
        {
            ...
            description: "Find suppliers, cooperatives, and agricultural offices near you.",
            ...
            <Card className="overflow-hidden">
                <div className="grid md:grid-cols-2">
                    <div className="p-6 md:p-8 flex flex-col justify-center">
                        <h1 className="text-3xl font-bold font-headline text-foreground">Welcome back, {profile?.role || 'User'}!</h1>
                    ...
                    <div className="relative h-64 md:h-full min-h-[250px]">
                        <Image src="https://placehold.co/600x400.png" alt="Farm illustration" layout="fill" objectFit="cover" data-ai-hint="farm tractor"/>
                    </div>
                </div>
            </Card>
